...
/**
 * Extension of the generated MessageService API client to adapt the handling of parameter values.
 */
public class MessageApiClient
    extends de.caritas.cob.videoservice.messageservice.generated.ApiClient {

  private static final String FILTER_NAME = "filter";

  public MessageApiClient(RestTemplate restTemplate) {
    super(restTemplate);
  }
